...
namespace onlinechildrenbookstore.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\106534\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
